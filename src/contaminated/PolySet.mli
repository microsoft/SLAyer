...
(** Input signature of the functor {!PolySet.Make}. *)
...
module type S =
  sig
    ...
    (** Same as {!PolySet.S.min_elt}, but returns the largest element of the
       given set. *)
...
(** Output signature of the functor {!PolySet.Make}. *)

module Make (Ord : OrderedType) : S with type 'k elt = 'k Ord.t
